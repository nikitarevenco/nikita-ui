...
import { Heading, type HeadingProps, SubHeading } from "@/components/heading";
...
export function AutoFocusHeading() {
  return (
    <div className="space-y-2 max-w-lg">
      ...
      <SubHeading>
        Use `autoFocus` to focus the heading. This is useful in SPA after
        navigation. A screen reader will then announce the new heading when it
        gets focus.
      </SubHeading>
    </div>
  );
